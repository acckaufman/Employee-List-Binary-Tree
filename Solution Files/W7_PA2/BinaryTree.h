...
public:
	...
	//*Note: this function has been modified for the EmployeeInfo program.		#
	//It assigns the name of the found employee to the searchItem, which is		#
	//passed by reference in this version.										#
	//###########################################################################
	bool searchNode(T &searchItem)
	{
		...
		while (nodePtr)
		{
			...
			{
				searchItem = nodePtr->value;		//To assign all the values contained in nodePtr->value to searchItem
